...
class CollectionViewHolder(
    ...
    // For Compose to recompose whenever the collection is updated we need an observable state.
    private val collectionData = MutableStateFlow(CollectionInfo())

    @Composable
    override fun Content() {
        val collectionInfo = collectionData.collectAsState().value

        collectionInfo.collection?.let { validCollection ->
            ...
            val menuItems = getMenuItems(
                ...
                onCollectionOpenTabsTapped = interactor::onCollectionOpenTabsTapped,
                onRenameCollectionTapped = interactor::onRenameCollectionTapped,
                onCollectionAddTabTapped = interactor::onCollectionAddTabTapped,
